    ...
    <div className="animate-in fade-in duration-500 pb-16">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <nav className="flex items-center gap-2 text-sm text-gray-400 mb-6">
          ...
          <span>/</span>
          <Link href={`/products?category=${encodeURIComponent(product.category)}`} className="hover:text-[#F59E0B] transition-colors">
            {product.category}
          </Link>
          <span>/</span>
          ...
          <div className="flex flex-col">
            ...
            <div className="bg-gray-50 rounded-xl p-4 mb-6 space-y-2 text-sm">
              ...
              <div className="flex justify-between">
                ...
                <Link href={`/products?category=${encodeURIComponent(product.category)}`} className="text-[#F59E0B] font-medium hover:underline">
                  {product.category}
                </Link>
              </div>
              <div className="flex justify-between">
